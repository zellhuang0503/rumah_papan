            ...
            <div className="flex justify-start items-center gap-[18px]">
                {FEATURES_DATA.map((feature, index) => (
                    <Link
                        key={index}
                        to={feature.path}
                        className="relative w-[408px] h-[108px] bg-white rounded-[18px] overflow-hidden group hover:shadow-lg transition-shadow"
                    >
                        ...
                        <div className="absolute left-[352.5px] top-[31.5px] p-[6px] rounded-full inline-flex justify-start items-center gap-[7.5px]">
                            <div className="relative w-[30px] h-[30px]">
                                <div className="absolute left-[6.5px] top-[5.25px] w-[18px] h-[21px] flex items-center justify-center border-[1.125px] border-neutral-900 rounded-full">
                        ...
                        <div className="absolute left-[18px] top-[27px] w-[150px] inline-flex flex-col justify-start items-start">
                            <div className="self-stretch justify-start text-neutral-900 text-[10.5px] font-medium font-['Roboto_Slab'] leading-[15px]">
                                {feature.subtitle}
                            </div>
