...
export const StoryCard: React.FC<StoryCardProps> = ({ item }) => {
    ...
    if (item.variant === 'text-overlay') {
        return (
            <>
                <MobileStoryCard item={item} />
                <div className={`hidden desktop:flex w-[408px] h-[360px] px-[24px] py-[42px] flex-col justify-end gap-[24px] bg-white ${containerBase}`}>
    ...
    if (item.variant === 'compact') {
        return (
            <>
                <MobileStoryCard item={item} />
                <div className={`hidden desktop:flex w-[288px] h-[360px] px-[42px] flex-col justify-center items-center gap-[12px] bg-white ${containerBase}`}>
