import story1 from '../assets/images/Image_legendary_pandamaran.jpg';
import story5 from '../assets/images/Image_pandamaran_daily.jpg';
import story9 from '../assets/images/Image_unknown_to_stories.jpg';
import story10 from '../assets/images/Image_house_story_gallery.jpg';
import story18 from '../assets/images/Image_volunteer_diary.jpg';
import story12 from '../assets/images/Image_bkt_table.jpg';
...
export interface StoryItem {
    ...
    // full = 100% width (1260px)
    // large = ~2/3 width (940px) or Highlight (514px)
    // medium = ~half or Overlay (408px)
    // small = Compact (288px)
}
...
export const stories: StoryItem[] = [
    ...
    // --- About Category ---
    // Row 1: Highlight + Overlay + Compact
    // 6. Highlight
    {
        id: '6',
        category: 'about',
    ...
    // 11. Compact (Orphaned? Let's make it start a new row if needed, or pair nicely)
    // Actually Standard Full takes full row. 11 can be start of next row?
    // Let's pair 11 with other items if we had more. 
    // For now, let's make 11 a Highlight to fill more space or just leave it.
    // Let's add companions to 11 to make a full row: Highlight + Overlay + Compact
    {
        id: '11',
        category: 'exchange',
        title: '在這裡，找回生活的實感',
    ...
    // --- Food Category ---
    // 12. Standard -> Needs Compact to fill 1260? 
    // Wait, Standard is 940px. Compact is 288px. 940+288+24 = 1252. OK.
    {
        id: '12',
        category: 'food',
    ...
    // Row 2: Overlay(408) + Highlight(514) + Compact(288) = 1258 OK
    // 14. Overlay
    {
        id: '14',
        category: 'food',
