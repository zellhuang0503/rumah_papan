...
export const VillageWorkSwap: React.FC = () => {
    ...
    }, [cmsData]); // Refresh layout when CMS data loads
    ...
    return (
        <div ref={containerRef} className="min-h-screen w-full bg-orange-100 relative overflow-x-hidden font-sans selection:bg-[#F1592C] selection:text-white pb-[120px]">
            ...
            <main className="w-full relative flex flex-col items-center pt-32 desktop:pt-[165px] gap-20 desktop:gap-[160px] px-6 desktop:px-0">
                ...
                {/* Zigzag Items List */}
                <section className="w-full max-w-[1240px] flex flex-col gap-12 desktop:gap-[40px] swap-list">
                    {WORK_SWAP_DATA.items.map((item, index) => (
                        <div key={index} className={`swap-item flex items-center gap-6 desktop:gap-[27px] flex-col-reverse ${index % 2 === 1 ? 'desktop:flex-row-reverse' : 'desktop:flex-row'} justify-center`}>
                            {/* Text Card */}
                ...
                {/* Booking CTA Section */}
                <section className="w-full flex justify-center px-6 desktop:px-0">
                    <div className="w-full max-w-[1240px] px-6 py-8 desktop:px-[84px] desktop:py-[72px] bg-white rounded-[18px] flex flex-col desktop:flex-row justify-between items-center shadow-sm gap-6 desktop:gap-0">
                ...
                {/* Notices Section */}
                <section className="w-full max-w-[1240px] flex flex-col items-center gap-[0px]">
                    {/* Title */}
